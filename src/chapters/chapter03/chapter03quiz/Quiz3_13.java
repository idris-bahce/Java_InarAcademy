	...
	public static void main(String[] args) {
		...
		if (status == 0) {
			...
			if (income <= 16700) {
				...
				tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137050) * 0.28
						+ (372951 - 208850) * 0.33 + (income - 371951) * 0.35;
			}
		} else if (status == 2) {
			if (income <= 8350) {
				tax = income * 0.10;
				...
				tax = 8350 * 0.10 + (33950 - 9350) * 0.15 + (income - 33950) * 0.25;
			} else if (income <= 104425) {
				tax = 8350 * 0.10 + (33950 - 9350) * 0.15 + (68525 - 33950) * 0.25 + (income - 104425) * 0.28;
			} else if (income <= 186475) {
				tax = 8350 * 0.10 + (33950 - 9350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28
						+ (income - 104425) * 0.33;
			} else {
				tax = 8350 * 0.10 + (33950 - 9350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28
						+ (186476 - 104425) * 0.33 + (income - 186476) * 0.35;
			}
		} else if (status == 3) {
			if (income <= 11950) {
				tax = income * 0.10;
